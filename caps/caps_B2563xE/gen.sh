...
#    Vrdc  uF  A  kA  kA  mQ nH kHz K/W mm  mm   kg  Part Number
#     600 180 55 1.4 4.2 0.9 13 104 6.8 50 54.5 0.39 B25632E0187K600
#

date_time=$(date '+%Y%m%d_%H%M%S' )

tmp_file=/tmp/B2563xE_${date_time}.awk
...
awk -f "${tmp_file}" B2563xE_a.txt > "${out_file}"
